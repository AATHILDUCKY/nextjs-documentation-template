...
- 🎨 **Tailwind CSS** – clean and elegant blue-white theme (`#1C3E66`).
- 📝 **Markdown/MDX Support** – easily write and manage articles in `/content/`.
- 🔍 **Smart Search** – search through articles and documentation instantly.
...
description: "Step-by-step guide for support engineers to reset user passwords or send reset emails in Welford IAG Support Portal."
date: "2025-11-16"
tags:
  - password reset
  - user management
